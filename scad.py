...
thickness_bottom_flat_piece = 1
thickness_bottom_angle_piece = 3 - thickness_bottom_flat_piece

thickness_bottom_straight_piece = thickness_bottom_total - thickness_bottom_angle_piece
...
def get_baseplate(thing, **kwargs):
    ...
    if True:
        ...
        wid = width_mm
        hei = height_mm
        dep = depth_mm #depth_mm - thickness_stack_interface
        wid_top = wid
        hei_top = hei
        size = [wid, hei, dep]
        p3["size"] = size     
        ...
        #p3["m"] = "#"
        pos1 = copy.deepcopy(pos)         
        pos1[2] += 0#thickness_stack_interface+thickness_stack_interface
        p3["pos"] = pos1
        oobb_base.append_full(thing,**p3)
        ...
        wid_count = width / 2
        hei_count = height / 2
        wid_cell = (2*15) - 2*thickness_wall + 2*thickness_baseplate_tolerance
...
def get_stackable_5(thing, **kwargs):
    global thickness_wall, thickness_base, thickness_stack_interface, clearance_inset_stacking, thickness_stack_interface   
    prepare_print = kwargs.get("prepare_print", False)
    width = kwargs.get("width", 1)
    height = kwargs.get("height", 1)
    ...
    if True:        
        ...
        for x in range(width_count):
            for y in range(height_count):                
                ...
                p3["rot"] = rot1
                oobb_base.append_full(thing,**p3)
                #new approach just lift it up
                if True:
                    p4 = copy.deepcopy(p3)
                    p4["type"] = "n"
                    pos2 = copy.deepcopy(pos1)
                    pos2[2] += thickness_bottom
                    p4["pos"] = pos2
                    p4["m"] = "#"
                    oobb_base.append_full(thing,**p4)
                    #cutout
...
def get_stackable_6(thing, **kwargs):
    global thickness_wall, thickness_base, thickness_stack_interface, clearance_inset_stacking, thickness_stack_interface   
    prepare_print = kwargs.get("prepare_print", False)
    width = kwargs.get("width", 1)
    height = kwargs.get("height", 1)
        ...
        for x in range(width_count):
            for y in range(height_count):                
                ...
                if True:
                    ...
                    p3["zz"] = "top"
                    pos2 = copy.deepcopy(pos1)
                    pos2[2] = thickness_bottom_flat_piece + thickness_bottom_angle_piece
                    p3["pos"] = pos2
                    oobb_base.append_full(thing,**p3)
...
def get_stackable_7(thing, **kwargs):
    prepare_print = kwargs.get("prepare_print", False)
    width = kwargs.get("width", 1)
    height = kwargs.get("height", 1)
    depth = kwargs.get("thickness", 3)                    
